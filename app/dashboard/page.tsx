...
export default function Dashboard() {
  ...
  const insuranceDeposit = "2500/2500 usdt"
  const exchangeRate = "79.71/86.09 (8.00%)"
    ...
    <MobileLayout title="Дашборд">
      ...
      <div className="bg-[rgb(31,41,55)] rounded-xl p-2 shadow-lg w-full mb-4">
        <div className="p-4">
          <div className="flex items-center h-12">
            ...
            />
            <div className="ml-4">
              <h2 className="text-xl font-bold tracking-tight text-white">Добро пожаловать, maccarty29</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[rgb(31,41,55)] rounded-2xl p-6 shadow-lg">
          ...
          <div className="flex items-center text-sm font-medium text-[rgb(75,85,99)] mt-2">
